            ...
            <div className="flex flex-row justify-center max-[1300px] mx-auto gap-x-5">
              ...
              <div className="w-[40%] mt-5 flex flex-col">
                ...
                <div className="flex flex-col">
                  ...
                  <button className="b  g-green-700 hover:bg-purple-50 rounded-lg text-white transition duration-300 ease-linear mt-5 border-2 border-green-600 font-bold hover:text-green-700 p-3 text-xl mr-10">
                    CheckOut Now
                  </button>
                </div>
              </div>
